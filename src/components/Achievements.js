...
import { FaBrain, FaCloud, FaChartLine, FaGlobe, FaCode, FaRocket } from 'react-icons/fa';

const Achievements = () => {
  const achievements = [
    {
      title: 'Full-Stack Development Excellence',
      description: 'Built and deployed production-ready applications using modern technologies and best practices',
      icon: FaCode,
      iconColor: 'text-blue-500',
      stats: [
        { label: 'Technologies', value: '10+', icon: FaCode },
        { label: 'Projects', value: '3', icon: FaRocket },
        { label: 'Deployment', value: '100%', icon: FaCloud }
      ],
      highlights: [
        'Modern React and Node.js development',
    ...
    },
    {
      ...
      description: 'Specialized in AI-powered applications with focus on practical problem-solving solutions',
      icon: FaBrain,
      iconColor: 'text-green-500',
      stats: [
        { label: 'AI APIs', value: '3+', icon: FaBrain },
        { label: 'Tech Stack', value: '10+', icon: FaCode },
        ...
        >
          <div className="glass-card p-8 max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
              ...
              Each project demonstrates the ability to transform complex requirements into elegant, user-friendly 
              solutions that make a real difference in people's daily workflows."
            </p>
