...
export const DATA = {
    ...
    skills: [
        ...
        { category: "Tools & DevOps", items: ["Git", "Vercel"] }
    ],
    projects: [
        {
            title: "Tokenizer",
